...
public class Block : MonoBehaviour
{
    ...
    private List<Vector2Int[]> shapes;
    ...
    void InitShapes()
    {
        shapes = new List<Vector2Int[]>
        {
            ...
            new Vector2Int[]{ new Vector2Int(0,0), new Vector2Int(1,0), new Vector2Int(2,0), new Vector2Int(3,0) }, // I shape
            new Vector2Int[]{ new Vector2Int(0,0), new Vector2Int(1,0), new Vector2Int(1,1), new Vector2Int(2,1) }, // Z shape
